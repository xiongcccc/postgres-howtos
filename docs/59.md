...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/development-tools/psql/psql-tuning.md) · 中文翻译与校订：PostgreSQL学徒
...
可以使用以下设置，并将其写入 `~/.psqlrc`，使后续 psql 会话也生效：
...
[postgres_dba](https://github.com/NikolayS/postgres_dba) 是我个人收集的 psql 脚本集，带有菜单支持：
