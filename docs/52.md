...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/performance-optimization/monitoring/how-to-reduce-wal-generation-rates.md) · 中文翻译与校订：xiongcc
...
要了解更多细节，参照 [Day 9: How to understand the LSN values and WAL file name](/docs/9.md)
