...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/performance-optimization/benchmarks/pre-and-post-steps-for-benchmark-iterations.md) · 中文翻译与校订：PostgreSQL学徒

在进行 PostgreSQL 基准测试时 (参照 [Day 13: How to benchmark](#/docs/13))，我们通常需要在相同的设置上运行多次基准测试迭代。为保证每次迭代的统一性，通常会在每次迭代前后执行以下步骤：
