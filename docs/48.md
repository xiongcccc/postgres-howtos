...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/development-tools/sql-techniques/how-to-generate-fake-data.md) · 中文翻译与校订：PostgreSQL学徒
...
此处我们展示如何使用第三种方式，使用 `plpython3u` 的"不受信任"版本 ([Day 47: How to install Postgres 16 with plpython3u](#/docs/47); 不适用于托管的 Postgres 服务，如 RDS；注意这种情况下"受信任"版本应该也适合)。
