...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/performance-optimization/indexing/how-to-find-redundent-indexes.md) · 中文翻译与校订：PostgreSQL学徒
...
我们之前讨论[未使用索引的 6 个原因](#/docs/75)同样适用于此处。
...
3. 可选地，考虑在实际删除索引之前使用"软删除"技术，如 [Day 53: Index maintenance](#/docs/53) 中所述。
