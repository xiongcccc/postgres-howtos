...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/postgresql-consulting/postgres-howtos/-/blob/41b389c5b820ab8e31255728c8b768774f4ff1bb/0007_pg_stat_statements_part_3.md) · 中文翻译与校订：xiongcc

前两篇文章：

- [How to work with pg_stat_statements, part 1](/docs/5.md?id=how-to-work-with-pg_stat_statements-part-1)
- [How to work with pg_stat_statements, part 2](/docs/6.md?id=how-to-work-with-pg_stat_statements-part-2)
...
如何计算：首先，针对所有查询组应用基于时间的微分 (如[第一部分](/docs/5.md)中讨论的 `dM/dt`)，然后将特定查询组的值除以所有查询组的总和。
