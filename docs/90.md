...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/development-tools/sql-techniques/how-to-use-lib-pgquery-in-shell.md) · 中文翻译与校订：xiongcc

## 为什么使用 lib_pgquery

在 [Day 12: How to find query examples for problematic pg_stat_statements records](/docs/12.md) 中提到，可以使用 [lib_pgquery](https://github.com/pganalyze/libpg_query) 标准化查询。这个库可以创建查询文本的树形表示，并计算所谓的"指纹" — 查询的标准化哈希 (移除所有参数后的查询文本)。
