...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/postgresql-consulting/postgres-howtos/-/blob/41b389c5b820ab8e31255728c8b768774f4ff1bb/0041_harmful_workloads.md) · 中文翻译与校订：PostgreSQL学徒

参照

- [Part 1: How to Corrupt](#/docs/39)
- [Part 2: Simulate infamous transaction ID wraparound](#/docs/40)
