...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/advanced-topics/misc/lsn-values-and-wal-filenames.md) · 中文翻译与校订：PostgreSQL学徒
...
LSN 是一个 8 字节（64 位）的值（[源码](https://gitlab.com/postgres/postgres/blob/4f2994647ff1e1209829a0085ca0c8d237dbbbb4/src/include/access/xlogdefs.h#L17)）。它表示为 `A/B`（更具体地说，`A/BBbbbbbb`，详见下文），斜杠两侧分别表示高 32 位和低 32 位。例如：
