...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/schema-design/constraints/how-to-remove-a-foreign-key.md) · 中文翻译与校订：xiongcc
...
同样的技巧也需要用于创建一个新外键操作的第一步，当我们使用 `NOT VALID` 选项定义一个新外键时，正如我们在第 70 天的 [How to add a foreign key](/docs/70.md) 中讨论的那样。

另外请参考：[day 71, How to understand what's blocking DDL](/docs/71.md)
