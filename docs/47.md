...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/advanced-topics/misc/how-to-install-postgres-16-with-plpython3u.md) · 中文翻译与校订：xiongcc
...
我们在 [Day 23: How to use OpenAI APIs right from Postgres to implement semantic search and GPT chat](/docs/23.md) 使用了 `plpython3u`  ，接下来我们将讨论如何安装它。
