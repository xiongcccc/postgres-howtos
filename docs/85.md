...
> 原作者：Nikolay Samokhvalov · [英文原文](https://gitlab.com/postgres-ai/docs/-/blob/80536bb97f28d1007ad09627db434c2b7016da1f/docs/postgres-howtos/schema-design/data-types/how-to-quickly-check-data-type-and-storage-size-of-a-value.md) · 中文翻译与校订：xiongcc
...
回想一下上一篇指南，[列拼图](/docs/84.md)，我们可以得出，不仅需要 1 字节来存储一个比特，如果我们创建一个表 (`c1 boolean`，`c2 int8`)，由于对齐填充，它会变成 8 个字节，达到了 64 位！因此，如果以 `text` 存储 'true'，也不会浪费存储：
